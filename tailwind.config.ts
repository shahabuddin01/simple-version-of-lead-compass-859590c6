    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "contacted-border": "hsl(var(--status-contacted-border))",
          ...
          "closed-border": "hsl(var(--status-closed-border))",
          "not-interested": "hsl(var(--status-not-interested))",
          "not-interested-bg": "hsl(var(--status-not-interested-bg))",
          "not-interested-border": "hsl(var(--status-not-interested-border))",
        },
        toggle: {
